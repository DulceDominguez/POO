...
class Vistas:
    ...
    def asignacion_de_funcion(self,tipo,accion,ventana):
        if tipo=="Coche":
            if accion=="insertar":
                self.insertar_autos(tipo,ventana)
            elif accion=="consultar":
                self.consultar_autos(tipo,ventana)
            elif accion=="cambiar":
                self.cambiar_autos(tipo,ventana)
            elif accion=="eliminar":
                self.borrar_autos(tipo,ventana)
        elif tipo=="Camion":
            if accion=="insertar":
                self.insertar_camiones(tipo,ventana)
            elif accion=="consultar":
                self.consultar_camiones(tipo,ventana)
            elif accion=="cambiar":
                self.cambiar_camiones(tipo,ventana)
            elif accion=="eliminar":
                self.borrar_camiones(tipo,ventana)
        elif tipo=="Camioneta":
            if accion=="insertar":
                self.insertar_camionetas(tipo,ventana)
            elif accion=="consultar":
                self.consultar_camionetas(tipo,ventana)
            elif accion=="cambiar":
                self.cambiar_camionetas(tipo,ventana)
            elif accion=="eliminar":
                self.borrar_camionetas(tipo,ventana)
    ...
    def consultar_autos(self,tipo,ventana):
        self.borrarPantalla(ventana)
    ...
    def borrar_autos(self,tipo,ventana):
        ventana.geometry("1000x1000")
        self.borrarPantalla(ventana)
    ...
    def insertar_camionetas(self,tipo,ventana):
        ventana.geometry("1000x1000")
        self.borrarPantalla(ventana)
        lbl_titulo=Label(ventana,text=f"Agregar {tipo}")
    ...
    def consultar_camionetas(self,tipo,ventana):
        self.borrarPantalla(ventana)
        ventana.geometry("1000x700")
        self.tabla = ttk.Treeview(ventana, columns=titulos, show='headings')
    ...
    def borrar_camionetas(self,tipo,ventana):
        lbl_ID=Label(ventana,text=f"Ingrese el ID de {tipo}: ")
        lbl_ID.pack(pady=7)
        txt_ID=Entry(ventana,width=25,justify="left")
        txt_ID.pack(pady=7)
    ...
    def consultar_camiones(self,tipo,ventana):
        self.borrarPantalla(ventana)
        ventana.geometry("1000x700")
