...
class App:
    #def _Init_, otra manera es poner los metidos como metodos estativcos y manadr llamar cada metodo, uno por uno como una funcion
    #Quitamos el self para ponerlo como estatico---App.menu_principal(constructor estatico(no crea objetos))
    #Si ponemos los metodos estaticos al momento de mandarlas llamar se debe mandar llamar el metodo en especifico que se ejecutara
    def menu_principal(self):
        ...
        .::  Menu Principal ::. 
            ...
            if opcion == '1' or opcion=="REGISTRO":
                ...
                password=getpass.getpass("\t Ingresa tu Contraseña: ")
                #Agregar codigo 
                registro=usuario.Usuario.iniciar_sesion(email,password)#name,apelli
                if registro:
