...
#usar los metodos estaticos para usarlos sin nececidad de crear objetos como el uso de una funcion en progrmamcion
#NO se puede mandar a llamar un metodo estatico directamente dentro de otro metodo estatico
    def crear(self):
        try:
          cursor.execute(
