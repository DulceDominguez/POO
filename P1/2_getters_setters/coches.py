...
print(f"Los valores de coche 1 son:{coche1.get_valores()}")
###############################################################
#OTRA MANERA DE HACERLO MAS SENCILLO O RESUMIDO:metodo que hace uso de una propiedad atravez de un decorativo, print<---.marca, la primera forma es mejor por ahora
